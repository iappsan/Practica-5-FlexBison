...
{
  "$end", "error", "$undefined", "ENTERO", "DECIMAL", "'+'", "'-'", "'/'",
  "'*'", "','", "'\\n'", "$accept", "input", "line", "exp", "dexp", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,   259,    43,    45,    47,    42,    44,
      10
};
# endif
...
{
      -2,     2,    -2,    -2,    -2,    -2,    -2,    67,    75,     0,
       0,     0,     0,    -2,    83,    90,     0,     0,     0,     0,
      -2,    83,    90,    97,   104,   106,   113,   106,   113,     0,
       0,    97,   104,   106,   113,   106,   113,     0,     0
};
...
{
       2,     0,     1,     7,    13,     4,     3,     0,     0,     0,
       0,     0,     0,     5,     9,    18,     0,     0,     0,     0,
       6,    19,    17,     8,    15,    10,    21,    11,    24,    12,
      27,    16,    14,    22,    20,    25,    23,    28,    26
};
...
{
       7,     0,     2,     3,     4,     3,     4,    21,    23,    25,
      27,    29,     5,     0,    21,    31,    33,    35,    37,     0,
       0,    21,     0,    21,     0,    21,     0,    21,     0,    21,
       0,    21,     8,    21,     0,    21,     0,    21,     0,    22,
      24,    26,    28,    30,     0,     0,    22,    32,    34,    36,
      38,     0,     0,    22,     0,    22,     0,    22,     0,    22,
       0,    22,     0,    22,     0,    22,     0,    22,     0,    22,
       3,     4,     9,     0,    10,    11,    12,    13,     3,     4,
      16,     0,    17,    18,    19,    20,     3,     4,     9,     0,
      10,    11,    12,     3,     4,    16,     0,    17,    18,    19,
       3,     4,     0,     0,    10,    11,    12,     3,     4,     3,
       4,    17,    18,    19,     0,    12,     3,     4,     0,     0,
       0,     0,    19
};

static const yytype_int8 yycheck[] =
{
       1,    -1,     0,     3,     4,     3,     4,     8,     9,    10,
      11,    12,    10,    -1,    15,    16,    17,    18,    19,    -1,
      -1,    22,    -1,    24,    -1,    26,    -1,    28,    -1,    30,
      -1,    32,     1,    34,    -1,    36,    -1,    38,    -1,     8,
       9,    10,    11,    12,    -1,    -1,    15,    16,    17,    18,
      19,    -1,    -1,    22,    -1,    24,    -1,    26,    -1,    28,
      -1,    30,    -1,    32,    -1,    34,    -1,    36,    -1,    38,
       3,     4,     5,    -1,     7,     8,     9,    10,     3,     4,
       5,    -1,     7,     8,     9,    10,     3,     4,     5,    -1,
       7,     8,     9,     3,     4,     5,    -1,     7,     8,     9,
       3,     4,    -1,    -1,     7,     8,     9,     3,     4,     3,
       4,     7,     8,     9,    -1,     9,     3,     4,    -1,    -1,
      -1,    -1,     9
...
{
       0,    12,     0,     3,     4,    10,    13,    14,    15,     5,
       7,     8,     9,    10,    14,    15,     5,     7,     8,     9,
...
#line 1357 "bison.tab.c"
  ...
  case 9:
#line 35 "bison.y"
                        { (yyval.entero) = (yyvsp[-1].entero) + (yyvsp[0].entero); }
...
#line 1411 "bison.tab.c"
  ...
  case 18:
#line 45 "bison.y"
                        { (yyval.decimal) = (yyvsp[-1].entero) + (yyvsp[0].decimal); }
#line 1417 "bison.tab.c"
    break;

  case 19:
#line 46 "bison.y"
                        { (yyval.decimal) = (yyvsp[-1].decimal) + (yyvsp[0].entero); }
